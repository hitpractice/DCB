...
public class UserRegisterActivity extends Activity implements OnClickListener {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (!hasFocus) {
                    if (register_username.getText().toString().trim().length() < 4) {
                        Toast.makeText(UserRegisterActivity.this, "用户名不能小于4个字符",
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (!hasFocus) {
                    if (register_passwd.getText().toString().trim().length() < 6) {
                        Toast.makeText(UserRegisterActivity.this, "密码不能小于8个字符",
                                Toast.LENGTH_SHORT).show();
                    }
                }
            }
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (!hasFocus) {
                    if (!reregister_passwd
                        ...
                        Toast.makeText(UserRegisterActivity.this, "两次密码输入不一致",
                                Toast.LENGTH_SHORT).show();
                    }
                }
            }
    ...
    private class InsertOnClickListenerImpl implements OnClickListener {
        ...
        public void onClick(View arg0) {
            // TODO Auto-generated method stub
            String user = UserRegisterActivity.this.register_username.getText()
                    .toString();
            String password = UserRegisterActivity.this.register_passwd.getText()
                    .toString();
            ...
            if (register_username.getText().toString().trim().length() < 4
                ...
                Toast myToast = Toast.makeText(UserRegisterActivity.this, "注册失败",
                        Toast.LENGTH_SHORT);
                ...
                Toast myToast = Toast.makeText(UserRegisterActivity.this, "注册成功",
                        Toast.LENGTH_SHORT);
                myToast.setGravity(Gravity.CENTER, 60, 30);
                LinearLayout myToastView = (LinearLayout) myToast.getView();
                ImageView img = new ImageView(UserRegisterActivity.this);
                ...
                UserRegisterActivity.this.mtab = new MytabOperate(
                        UserRegisterActivity.this.helper.getWritableDatabase());
                UserRegisterActivity.this.mtab.insert2(user, password);
            }
